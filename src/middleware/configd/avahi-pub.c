...
static void entry_group_callback(AvahiEntryGroup *g, AvahiEntryGroupState state, AVAHI_GCC_UNUSED void *userdata) {
    ...
    switch (state) {
        ...
        case AVAHI_ENTRY_GROUP_UNCOMMITED:
            fprintf(stderr, "Entry group failure: uncommitted\n");
            break;

        case AVAHI_ENTRY_GROUP_REGISTERING:
            fprintf(stderr, "Entry group failure: registering\n");
            break;
            ;
    }
}
...
static void create_services(AvahiClient *c) {
    ...
    if (avahi_entry_group_is_empty(group)) {
        ...
        if ((ret = avahi_entry_group_add_service(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, 0, name, "_hotdec._tcp", NULL, NULL, 651, "test=blah", r, NULL)) < 0) {
...
static void client_callback(AvahiClient *c, AvahiClientState state, AVAHI_GCC_UNUSED void * userdata) {
    ...
    switch (state) {
        case AVAHI_CLIENT_S_RUNNING:
            fprintf(stderr, "Client CLIENT_S_RUNNING\n");
        ...
        case AVAHI_CLIENT_S_COLLISION:
            fprintf(stderr, "Client CLIENT_S_COLLISION\n");
        ...
        case AVAHI_CLIENT_S_REGISTERING:
            fprintf(stderr, "Client CLIENT_S_REGISTERING\n");
        ...
        case AVAHI_CLIENT_CONNECTING:
            fprintf(stderr, "Client CLIENT_S_CONNECTING\n");
