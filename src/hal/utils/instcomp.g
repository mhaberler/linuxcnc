...
######################  preliminary defines before user FUNCTION(_) ######################################
    ...
    if not options.get("no_convenience_defines"):
        ...
        if (pin_ptrs):
            print >>f, "#undef gb"
            print >>f, "#define gb(x)  get_bit_pin(x)"
            print >>f, "#undef gs"
            print >>f, "#define gs(x)  get_s32_pin(x)"
            print >>f, "#undef gu"
            print >>f, "#define gu(x)  get_u32_pin(x)"
            print >>f, "#undef gf"
            print >>f, "#define gf(x)  get_float_pin(x)"
            print >>f, "#undef sb"
            print >>f, "#define sb(x, y)  set_bit_pin(x, y)"
            print >>f, "#undef ss"
            print >>f, "#define ss(x, y)  set_s32_pin(x, y)"
            print >>f, "#undef su"
            print >>f, "#define su(x, y)  set_u32_pin(x, y)"
            print >>f, "#undef sf"
            print >>f, "#define sf(x, y)  set_float_pin(x, y)"
            print >>f, "#undef incs"
            print >>f, "#define incs(x)  ss(x, (gs(x) + 1))"
            print >>f, "#undef decs"
            print >>f, "#define decs(x)  ss(x, (gs(x) - 1))"
            print >>f, "#undef incu"
            print >>f, "#define incu(x)  incr_u32_pin(x, +1)"
            print >>f, "#undef decu"
            print >>f, "#define decu(x)  incr_u32_pin(x, - 1)"
    print >>f
    print >>f
