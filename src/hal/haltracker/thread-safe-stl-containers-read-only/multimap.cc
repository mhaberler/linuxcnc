...
int main()
{
  ...
  thread_safe::multimap<string, int> m;
  ...
  for (thread_safe::multimap<string, int>::iterator it = m.begin();
       it != m.end();
       ++it)
   {
   ...
   pair<thread_safe::multimap<string, int>::iterator, thread_safe::multimap<string, int>::iterator> ppp;
   ...
   for (thread_safe::multimap<string, int>::iterator it2 = ppp.first;
       it2 != ppp.second;
       ++it2)
   {
